/**
 * useTauriTimer.ts — Sound map and audio utilities (legacy compatibility module).
 *
 * NOTE: This module is now a thin sound-constants shim.
 * The timer engine has been replaced by the Rust-driven tick loop in
 * timerStore.ts / timer_engine.rs. This file is kept for SOUND_MAP
 * imports in TimerCard, SettingsPanel, PresetButtons, CustomTimerForm.
 *
 * Do NOT add timer logic back here.
 */
